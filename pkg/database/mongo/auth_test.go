...
func TestStartAuthenticates(t *testing.T) {
	...
	suffix := randomHex(t)
	testDB, otherDB := "process_io_auth_test_"+suffix, "process_io_auth_other_"+suffix
	svcUser, svcPassword := "process-io-test-"+suffix, randomHex(t)
	otherUser, otherPassword := "process-io-other-"+suffix, randomHex(t)
